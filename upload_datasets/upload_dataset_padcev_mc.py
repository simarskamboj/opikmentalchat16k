...
json_file = "data/padcev_mc.json"  # Ensure it's named .json
...
for item in data:
    transformed_data.append({
        ...
        "context": item.get("expected_output", ""),  # Ensure context is included, default to empty string if missing
...
dataset = client.get_or_create_dataset(name="PadcevQAMC")
